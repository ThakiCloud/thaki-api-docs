...
제공된 YAML 스펙을 기반으로 NetworkPolicy를 생성합니다.

## HTTP 요청

```http
POST https://<your-console-host>/api/v1/container/policy/network-policy
```
...
| result.networkPolicyName | 필수 | string | 생성된 NetworkPolicy 이름 |
