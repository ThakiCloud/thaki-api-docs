...
```http
PUT https://<your-console-host>/api/v1/container/service-routing/ingress/{ingress_name}
```
...
| 이름 | 필수 | 형식 | 설명 |
|---|---|---|---|
| yamlContent | 필수 | string | Ingress 정의 YAML 문자열 |
...
| result.ingressName | 필수 | string | 수정된 Ingress 이름 |
