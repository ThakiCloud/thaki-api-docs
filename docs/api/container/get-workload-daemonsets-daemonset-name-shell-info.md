# DaemonSet Shell 연결 정보 조회

DaemonSet에 속한 가장 최신의 Running Pod를 기준으로 Shell 연결 정보를 조회합니다.

### Pod 선택 기준

1. DaemonSet에 속한 Pod 목록 조회
...
```http
GET https://<your-console-host>/api/v1/container/workload/daemonsets/{daemonset_name}/shell/info
```
