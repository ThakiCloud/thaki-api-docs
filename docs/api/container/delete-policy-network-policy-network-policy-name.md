...
특정 클러스터 및 네임스페이스에서 NetworkPolicy를 삭제합니다.

## HTTP 요청

```http
DELETE https://<your-console-host>/api/v1/container/policy/network-policy/{network_policy_name}
```
...
| result.networkPolicyName | 필수 | string | 삭제된 NetworkPolicy 이름 |
