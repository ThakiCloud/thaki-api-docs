...
특정 클러스터 및 네임스페이스에서 CronJob을 삭제합니다.

## HTTP 요청

```http
DELETE https://<your-console-host>/api/v1/container/workload/cronjobs/{cronjob_name}
```
...
| result.cronjobName | 필수 | string | 삭제된 CronJob 이름 |
