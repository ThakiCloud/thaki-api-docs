...
특정 클러스터와 네임스페이스에서 Service를 삭제합니다.

## HTTP 요청

```http
DELETE https://<your-console-host>/api/v1/container/service-routing/service/{service_name}
```
...
| result.serviceName | 필수 | string | 삭제된 Service 이름 |
