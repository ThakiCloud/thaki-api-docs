...
YAML 스펙을 기반으로 Kubernetes 클러스터의 기존 CronJob을 수정합니다.

## HTTP 요청

```http
PUT https://<your-console-host>/api/v1/container/workload/cronjobs/{cronjob_name}
```
...
| 이름 | 필수 | 형식 | 설명 |
|---|---|---|---|
| yamlContent | 필수 | string | CronJob 정의 YAML 문자열 |
...
| result.cronjobName | 필수 | string | 수정된 CronJob 이름 |
