...
kubectl rollout restart daemonset와 동일한 동작을 수행합니다.
Pod 템플릿에 restartedAt 어노테이션을 추가하여 새로운 롤아웃을 트리거합니다.

See Also:
    [API 문서](https://www.notion.so/2be9eddc34e681cc92a5c48cc4d3490b)

## HTTP 요청

```http
POST https://<your-console-host>/api/v1/container/workload/daemonsets/{daemonset_name}/redeploy
```
...
| result.daemonsetName | 필수 | string | 재배포된 DaemonSet 이름 |
