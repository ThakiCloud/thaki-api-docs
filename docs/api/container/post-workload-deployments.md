...
제공된 YAML 스펙을 기반으로 Deployment를 생성합니다.

See Also:
    [API 문서](https://www.notion.so/2bc9eddc34e68119982acd71fabab2e6)

## HTTP 요청

```http
POST https://<your-console-host>/api/v1/container/workload/deployments
```
...
| 이름 | 필수 | 형식 | 설명 |
|---|---|---|---|
| yamlContent | 필수 | string | Deployment 정의 YAML 문자열 |
...
| result.deploymentName | 필수 | string | 생성된 Deployment 이름 |
