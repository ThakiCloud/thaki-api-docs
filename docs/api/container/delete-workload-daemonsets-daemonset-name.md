...
특정 클러스터 및 네임스페이스에서 DaemonSet을 삭제합니다.

See Also:
    [API 문서](https://www.notion.so/2be9eddc34e681afaa3ed21916749e40)

## HTTP 요청

```http
DELETE https://<your-console-host>/api/v1/container/workload/daemonsets/{daemonset_name}
```
...
| result.daemonsetName | 필수 | string | 삭제된 DaemonSet 이름 |
