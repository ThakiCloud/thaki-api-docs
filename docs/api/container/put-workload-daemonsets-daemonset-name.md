...
```http
PUT https://<your-console-host>/api/v1/container/workload/daemonsets/{daemonset_name}
```
...
| 이름 | 필수 | 형식 | 설명 |
|---|---|---|---|
| yamlContent | 필수 | string | DaemonSet 정의 YAML 문자열 |
...
| result.daemonsetName | 필수 | string | 수정된 DaemonSet 이름 |
