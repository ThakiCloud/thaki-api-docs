...
특정 클러스터 및 네임스페이스에서 ResourceQuota를 삭제합니다.

## HTTP 요청

```http
DELETE https://<your-console-host>/api/v1/container/policy/resource-quota/{resource_quota_name}
```
...
| result.resourceQuotaName | 필수 | string | 삭제된 ResourceQuota 이름 |
