# Get Existing Pdb Yaml

기존 PodDisruptionBudget YAML 조회

특정 클러스터 및 네임스페이스에 존재하는 PodDisruptionBudget의 YAML 정의를 조회합니다.

## HTTP 요청

```http
GET https://<your-console-host>/api/v1/container/policy/pod-disruption-budget/{pdb_name}/manifest
```
