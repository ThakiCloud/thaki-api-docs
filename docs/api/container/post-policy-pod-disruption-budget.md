...
제공된 YAML 스펙을 기반으로 PodDisruptionBudget를 생성합니다.

## HTTP 요청

```http
POST https://<your-console-host>/api/v1/container/policy/pod-disruption-budget
```
...
| result.pdbName | 필수 | string | 생성된 PodDisruptionBudget 이름 |
