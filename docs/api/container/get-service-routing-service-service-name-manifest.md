# Get Existing Service Yaml

기존 Service YAML 조회

특정 클러스터와 네임스페이스에 존재하는 Service의 YAML 정의를 조회합니다.

## HTTP 요청

```http
GET https://<your-console-host>/api/v1/container/service-routing/service/{service_name}/manifest
```
