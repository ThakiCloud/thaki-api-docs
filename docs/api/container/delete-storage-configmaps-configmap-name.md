...
특정 클러스터 및 네임스페이스에서 ConfigMap을 삭제합니다.

## HTTP 요청

```http
DELETE https://<your-console-host>/api/v1/container/storage/configmaps/{configmap_name}
```
...
| result.configmapName | 필수 | string | 삭제된 ConfigMap 이름 |
