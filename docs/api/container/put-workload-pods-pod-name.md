...
YAML 스펙을 기반으로 Kubernetes 클러스터의 기존 Pod를 수정합니다.

## HTTP 요청

```http
PUT https://<your-console-host>/api/v1/container/workload/pods/{pod_name}
```
...
| 이름 | 필수 | 형식 | 설명 |
|---|---|---|---|
| yamlContent | 필수 | string | Pod 정의 YAML 문자열 |
...
| result.podName | 필수 | string | 수정된 Pod 이름 |
