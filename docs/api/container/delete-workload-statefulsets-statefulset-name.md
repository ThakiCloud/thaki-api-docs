...
특정 클러스터 및 네임스페이스에서 StatefulSet을 삭제합니다.

See Also:
    [API 문서](https://www.notion.so/2bd9eddc34e681e98ffff57239490015)

## HTTP 요청

```http
DELETE https://<your-console-host>/api/v1/container/workload/statefulsets/{statefulset_name}
```
...
| result.statefulsetName | 필수 | string | 삭제된 StatefulSet 이름 |
