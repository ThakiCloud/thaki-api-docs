...
- Regular Containers (`pod.spec.containers`)
- Init Containers (`pod.spec.initContainers`)

## HTTP 요청

```http
GET https://<your-console-host>/api/v1/container/workload/pods/{pod_name}/shell/info
```
