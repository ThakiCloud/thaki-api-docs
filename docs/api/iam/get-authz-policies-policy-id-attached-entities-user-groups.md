...
| name | 선택 | string 또는 null | 그룹명 부분 일치 필터. 그룹명 부분 일치 필터 |
| id | 선택 | string 또는 null | 그룹 ID 부분 일치 필터. 그룹 ID 부분 일치 필터 |
| memberCountGte | 선택 | integer 또는 null | 멤버 수 최소값 (포함). 멤버 수 최소값 (포함) |
| memberCountLte | 선택 | integer 또는 null | 멤버 수 최대값 (포함). 멤버 수 최대값 (포함) |
