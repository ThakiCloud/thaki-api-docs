...
```http
PATCH https://<your-console-host>/api/v1/iam/authn/service-accounts/{sa_id}/keys/{key_id}
```
...
| 이름 | 필수 | 형식 | 설명 |
|---|---|---|---|
| description | 선택 | string 또는 null | 길이 0~512 |
| enabled | 선택 | boolean 또는 null | 키 활성/비활성 (true=enable, false=disable, 생략=변경없음) |
