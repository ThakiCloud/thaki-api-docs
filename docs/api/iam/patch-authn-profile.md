# 인증된 사용자가 자신의 프로필 정보 수정

인증된 사용자가 자신의 프로필 정보를 수정합니다.

## HTTP 요청

```http
PATCH https://<your-console-host>/api/v1/iam/authn/profile
```
...
| 이름 | 필수 | 형식 | 설명 |
|---|---|---|---|
| displayName | 선택 | string 또는 null | 표시 이름. 길이 0~128 |
| email | 선택 | string 또는 null | 이메일 주소 |
