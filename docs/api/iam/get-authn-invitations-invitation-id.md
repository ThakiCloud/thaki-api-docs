...
- `invitation_id`에 해당하는 초대를 조회합니다.
- **권한**: `iam:invitation:read`

## HTTP 요청

```http
GET https://<your-console-host>/api/v1/iam/authn/invitations/{invitation_id}
```
...
| 이름 | 위치 | 필수 | 형식 | 설명 |
|---|---|---|---|---|
| invitation_id | path | 필수 | string | 초대 ID. 초대 ID |
