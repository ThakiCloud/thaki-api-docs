# 조직의 MFA 정책(MFA 필수 여부 및 허용되는 MFA 방법) 조회

조직의 MFA 정책(MFA 필수 여부 및 허용되는 MFA 방법)을 조회합니다.

## HTTP 요청

```http
GET https://<your-console-host>/api/v1/iam/authn/organizations/{org_id}/mfa-policy
```
