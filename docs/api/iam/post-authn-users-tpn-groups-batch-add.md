# 한 명의 사용자를 여러 그룹에 동시에 추

한 명의 사용자를 여러 그룹에 동시에 추가합니다.

## HTTP 요청

```http
POST https://<your-console-host>/api/v1/iam/authn/users/{tpn}/groups:batch-add
```
...
| 이름 | 필수 | 형식 | 설명 |
|---|---|---|---|
| groupIds | 필수 | array (string) | 추가할 그룹 ID 목록 (최대 100개) |
