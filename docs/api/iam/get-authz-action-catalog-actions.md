...
| 이름 | 필수 | 형식 | 설명 |
|---|---|---|---|
| app | 선택 | string 또는 null | App 필터 (대소문자 무관). App 필터 (대소문자 무관) |
| alias | 선택 | string 또는 null | Alias 필터. Alias 필터 |
| method | 선택 | string 또는 null | HTTP Method 필터. HTTP Method 필터 |
| resourceType | 선택 | string 또는 null | 리소스 타입 필터 (대소문자 무관, 예: instance, network). 리소스 타입 필터 (대소문자 무관, 예: instance, network) |
