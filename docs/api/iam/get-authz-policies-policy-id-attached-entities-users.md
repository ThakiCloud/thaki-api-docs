...
| username | 선택 | string 또는 null | 사용자명 부분 일치 필터. 사용자명 부분 일치 필터 |
| status | 선택 | string 또는 null | 상태 필터. 상태 필터 |
| attachment | 선택 | string 또는 null | 연결 경로 필터 (Direct \| Group \| Role). 연결 경로 필터 (Direct \| Group \| Role) |
| id | 선택 | string 또는 null | 식별자(TPN) 부분 일치 필터. 식별자(TPN) 부분 일치 필터 |
