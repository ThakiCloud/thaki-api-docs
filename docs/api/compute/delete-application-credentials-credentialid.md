...
```http
DELETE https://<your-console-host>/api/v1/compute/application-credentials/{credentialId}
```
...
| 이름 | 위치 | 필수 | 형식 | 설명 |
|---|---|---|---|---|
| credentialId | path | 필수 | string | Application Credential ID. Application Credential ID |
