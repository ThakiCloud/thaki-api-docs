...
| 이름 | 필수 | 형식 | 설명 |
|---|---|---|---|
| action | 필수 | string | 수행할 액션. 값: start, stop, pause, unpause, suspend, resume, shelve, unshelve, lock, unlock, softReboot, reboot, rebuild, resize, confirmResize, revertResize, attachVolume, detachVolume, attachInterface, detachInterface, rescue, unrescue |
