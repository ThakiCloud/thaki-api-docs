...
```http
POST https://<your-console-host>/api/v1/compute/instance-snapshots
```
...
| 이름 | 필수 | 형식 | 설명 |
|---|---|---|---|
| instanceId | 필수 | string | 인스턴스 ID |
| instanceSnapshotName | 필수 | string | 스냅샷 이름 (1~255자, 인쇄 가능 문자, 선행/후행 공백 금지) |
| description | 선택 | string 또는 null | 스냅샷 설명 |
