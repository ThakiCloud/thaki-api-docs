...
```http
POST https://<your-console-host>/api/v1/network/routers/{routerId}/routes
```
...
| 이름 | 필수 | 형식 | 설명 |
|---|---|---|---|
| destination | 필수 | string | 목적지 CIDR (예: 10.0.0.0/24) |
| nexthop | 필수 | string | 다음 홉 IP 주소 (예: 192.168.1.1) |
