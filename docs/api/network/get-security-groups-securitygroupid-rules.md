...
```http
GET https://<your-console-host>/api/v1/network/security-groups/{securityGroupId}/rules
```
...
| result.data[].remoteIpPrefix | 필수 | string 또는 null |  |
| result.data[].remoteGroupId | 필수 | string 또는 null |  |
| result.data[].remoteGroupName | 선택 | string 또는 null |  |
| result.data[].remoteAddressGroupId | 필수 | string 또는 null |  |
| result.data[].normalizedCidr | 필수 | string 또는 null |  |
| result.data[].securityGroupId | 필수 | string |  |
| result.data[].description | 필수 | string 또는 null |  |
| result.data[].projectId | 필수 | string 또는 null |  |
| result.data[].tenantId | 필수 | string 또는 null |  |
| result.data[].standardAttrId | 필수 | integer 또는 null |  |
